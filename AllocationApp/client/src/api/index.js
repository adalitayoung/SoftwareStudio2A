...
export const updatePreference = (tempStudent) =>
  api.post(`/user/updatePreference`, tempStudent);

export const updateTechBackground = (tempStudent) =>
  api.post(`/user/updateTechBackground`, tempStudent);
